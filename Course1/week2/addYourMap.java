...
/** addYourMap
  ...
  * Date: July 17, 2015
  * */
public class addYourMap extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 100, 100, 515, 700, provider);
		map2 = new UnfoldingMap(this, 665, 100, 515, 700, provider2);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(27.2f, 77.5f));
